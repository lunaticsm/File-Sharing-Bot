...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "6256980059:AAFhJJ7wkQEUg-4uKjPDCIybeElNuv7_gtw")
...
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1001886252716"))
...
try:
    ADMINS = [
        ...
        for x in (
            os.environ.get(
                "ADMINS",
                "1533276197 1446429955 5219588460",
            ).split()
        )
    ]
except ValueError:
