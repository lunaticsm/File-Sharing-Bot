...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "5901836797:AAGf3JHZX_Ph3PGxPSLQFxzKnREGxbN04hU")
...
#Database 
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://p:pendii11@cluster0.dplzyot.mongodb.net/?retryWrites=true&w=majority")
DB_NAME = os.environ.get("DATABASE_NAME", "filesharexbot")


#force sub channel id, if you want enable force sub
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1001898397254"))
...
try:
    ADMINS = [
        ...
        for x in (
            os.environ.get(
                "ADMINS",
                "5476364982 1735137313 5407115463 1735137313 5289178185 1735137313 5307017976",
            ).split()
        )
    ]
except ValueError:
